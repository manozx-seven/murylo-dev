...
async function copyLink() {
    ...
    msg._hideTimeout = setTimeout(() => msg.classList.remove('show'), 2000);
}
...
function handleMove(e) {
    ...
    if (dist > 15 && now - lastTime > 30) {
        ...
        if (trails.length < 150) trails.push(new EnergyTrail(spawnX, spawnY, vx, vy, true));
...
function animate() {
    ...
    for (let i = 0; i < particles.length; i++) {
        ...
        // Conexões (evita sqrt desnecessário com comparação quadrática)
        let connections = 0;
